  ...
  if(userList.size()>0){
    ...
    if(kinect.isTrackingSkeleton(userId)){
      ...
      pushMatrix();
        ...
        stroke(255,0,0);
        strokeWeight(5);
        line(0,0,0, TorsionCoordinatesX.x * 500, TorsionCoordinatesX.y * 500, TorsionCoordinatesX.z * 500);
        stroke(0,255,0);
        line(0,0,0, TorsionCoordinatesY.x * 500, TorsionCoordinatesY.y * 500, TorsionCoordinatesY.z * 500);
        stroke(0,0,255);
        line(0,0,0, TorsionCoordinatesZ.x * 500, TorsionCoordinatesZ.y * 500, TorsionCoordinatesZ.z * 500);
        //debug
        
        PVector Hh = EtoS.get();
        Hh.mult(HtoS.dot(Hh) / (Hh.mag() * Hh.mag()) );
        PVector Sh = new PVector();
        Sh = PVector.add(StoH, Hh);
        PVector Stand = new PVector();
        Stand.set(0,10,0);
        int TorsionAngle = get_angle(Sh,Stand);
      popMatrix();
